...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="w-full">
                <div class="font-poppins-400 text-xl w-full space-y-12 px-5 py-5 font-bold">
                    ...
                    <div class="grid gap-11 grid-cols-1  xl:grid-cols-3 md:grid-cols-2 ">
                        ...
                        <input id="hdnMaterialDetailID" type="hidden" />
    ...
    <script>
        ...
        $("#btnSave").on('click', function () {
            ...
            var MaterialDetailID = $('#hdnMaterialDetailID');
            ...
            if (Validate == true) {
                ...
                var MaterialDetailID = MaterialDetailID.val() == "" ? 0 : MaterialDetailID.val();
                ...
                $.ajax({
                    ...
                    method: "POST",
                    data: "{MaterialDetailID:" + JSON.stringify(MaterialDetailID) + ", MaterialName:" + JSON.stringify(MaterialName) + ",MeasuredIn:" + JSON.stringify(MeasuredIn) + " ,MaterialCategoryID:" + JSON.stringify(MaterialCategoryID) + ", MaterialPhoto:" + JSON.stringify(MaterialPhoto) + "}",
        ...
        function FillMaterialDetailIDetails(MaterialDetailID) {
            $.ajax({

                url: "WebServices/MaterialMasterWebService.asmx/MaterialDetailGet",
                method: "POST",
                data: "{MaterialDetailID:" + JSON.stringify(MaterialDetailID) + "}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: OnSuccess,
                async: false,
        ...
        function OnSuccess(response) {
            ...
            if (Details.length > 0) {
                $.each(Details, function () {
                    ...
                    strEditDelete += " <input class='bg-yellow-900 mx-2 text-center text-white py-3 px-5 hover:bg-yellow-700 cursor-pointer' onclick='EditMaterial(" + $(this).find("MaterialDetailID").text() + ")' type='button' value='Edit' />";
                    strEditDelete += " <input class='bg-red-900 mx-2 text-center text-white py-3 px-5 hover:bg-red-600 cursor-pointer' onclick='DeleteMaterial(" + $(this).find("MaterialDetailID").text() + ",\"" + $(this).find("MaterialPhoto").text() + "\")' type='button' value='Delete' />";
        ...
        function EditMaterial(MaterialDetailID) {
            $.ajax({
        ...
        function OnEditSuccess(response) {
            ...
            $("[id=hdnMaterialDetailID]").val(Details.find("MaterialDetailID").text());
        ...
        function DeleteMaterial(MaterialDetailID, MaterialPhoto) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        method: "POST",
                        data: "{MaterialDetailID:" + JSON.stringify(MaterialDetailID) + ", MaterialPhoto:" + JSON.stringify(MaterialPhoto) + "}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (res) {
                            var result = res.d;
