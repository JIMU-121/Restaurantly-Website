...
<body>
                ...
                <div class="bg-classic-brown flex justify-center items-center text-center h-[350px] w-[400px] shadow-2xl opacity-95 text-classic-yellow">
                    <div class="space-y-10">
                        ...
                        <div class="space-y-10">
                            ...
                            <div>
                                <input id="btnLogin" class="bg-yellow-900 text-white py-3 px-10 hover:bg-yellow-700 cursor-pointer active:bg-black" type="button" value="LOGIN" />
                            </div>
                        </div>
                        <div>
                        </div>
    ...
    <script>
        $("#btnLogin").on('click', function () {
            ...
            $.ajax({
                url: "Webservices/LoginWebService.asmx/LoginCheck",
                method: "POST",
