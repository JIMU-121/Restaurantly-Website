<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Dishes.aspx.cs" Inherits="Admin_DishMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function ListAllMaterial(MaterialCategoryID) {


            $.ajax({
                url: "Webservices/MaterialMasterWebService.asmx/ListAllMaterialCategory",
                method: "POST",
